...
Page({
  ...
  requestDataList: function (isShowLoading) {
    ...
    var paramData = { CourseId: classid, usertoken: userToken, token: token };
    if (isShowLoading) utils.wxShowLoading("请稍候...", true);
    var arrrr = datas.myschedulecardList//数据在这———————————————————————————————————————————————————————————————————————————
    // http://api.school.comz/Scheduling/SchedulingList?CourseId=3&usertoken=20180625160626456429&token=sddww111
    //发起请求
