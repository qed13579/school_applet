...
Page({
  ...
  tocoursedetail: function (e) {
    ...
    wx.navigateTo({
      url: '/pages/course/coursedetail/coursedetail?id=' + e.currentTarget.dataset.id + "&typename=" + e.currentTarget.dataset.typename + "&desc=" + e.currentTarget.dataset.detail + "&img=" + e.currentTarget.dataset.img
    })
  },
  toschedulecard: function (e) {
    console.log(e.currentTarget.dataset.id);
    wx.navigateTo({
      url: "/pages/course/coursebuy/coursebuy?id=" + e.currentTarget.dataset.id + "&num=" + e.currentTarget.dataset.num + "&orderid=" + e.currentTarget.dataset.orderid + "&img=" + e.currentTarget.dataset.img + "&typename=" + e.currentTarget.dataset.typename + "&classname=" + e.currentTarget.dataset.classname,
  ...
  tips:function(e){
      ...
      //   showCancel: true,
      //   success: function(res) {
      //     console.log(e.currentTarget.dataset.id)//传入订单id删除订单
      //   },
      //   fail: function(res) {},
      //   complete: function(res) {},
      // })
    ...
    console.log(e.currentTarget.dataset.id);
    wx.navigateTo({
      url: "/pages/course/coursebuy/coursebuy?id=" + e.currentTarget.dataset.id + "&num=" + e.currentTarget.dataset.num + "&orderid=" + e.currentTarget.dataset.orderid,
      success: function (res) { },
      fail: function (res) { },
      complete: function (res) { },
    })
  ...
  requestDataList: function (isShowLoading) {//获取课程信息+________________________________+_+_+________________________+_
    var that = this;
    // http://api.school.comz/MineCourse/MineCourseList?token=sddww111&userToken=201806251040493d4dc5
    var apiUrl = app.globalData.webUrl + "/MineCourse/MineCourseList";
